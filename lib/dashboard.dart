...
class _DashboardPageState extends State<DashboardPage> {
            ...
            child: ListView(
              children: <Widget>[
                ...
                _buildListItemGastos('assets/gas.jpg', 'Gastos',
                    ...
                    _buildListInventario('assets/inve.jpg', 'Inventario',
                    'Ver Su Inventario'),
  ...
  _buildListItemGastos(String imgPath, String country, String description) {
    return Padding(
        padding: EdgeInsets.all(15.0),
        child: Stack(
          children: <Widget>[
                ...
                child: Center(
                  ...
                  children: <Widget>[
                    ...
                    InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => Gastos(imgPath: imgPath, title: country)));
                        },
                        child: Container(
                            height: 50.0,
                            width: 125.0,
